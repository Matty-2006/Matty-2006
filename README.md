...
# Mateo Rodríguez 👋
### Software Development Student @ EPN (ESFOT) 🎓 | Junior Developer 💻
...
const mateo = {
  ...
  code: ["Java", "JavaScript", "Python", "SQL", "NoSQL"],
  frameworks: ["Spring Boot", "React", "Node.js", "Express", "JavaFX"],
  tools: ["Git", "GitLab", "KNIME", "Power BI", "Docker", "Git LFS"],
  dataAnalytics: ["ETL Pipelines", "Data Cleaning", "JasperReports"],
  architecture: ["REST APIs", "MVC", "Database Optimization"],
  currentFocus: "Building enterprise applications & scalable software solution design"
};
